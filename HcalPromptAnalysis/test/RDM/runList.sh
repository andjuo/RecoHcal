...
do 
	...
	sqlplus cms_hcl_runinfo/run2009info@cms_rcms @checkGlobal.sql $i | grep -q GLOBAL
...
sqlplus cms_hcl_runinfo/run2009info@cms_rcms @tmp.sql | grep -v "rows selected" | cat -s
