...
'file:/afs/cern.ch/work/z/zhokin/hcal/CMSSW_7_4_0_pre9/src/RecoHcal/HcalPromptAnalysis/test/rfiles/USC_211006.root'
   ), 
#
#
...
process.Analyzer = cms.EDAnalyzer("VeRawAnalyzer",
                                  ...
                                  TSmeanHBMax = cms.double(4.5),
                                  TSmeanHEMin = cms.double(1.0),
                                  TSmeanHEMax = cms.double(4.75),
                                  ...
                                  #Verbosity = cms.untracked.int32(-55),
                                  TSpeakHBMin = cms.double(2.5),
                                  TSpeakHBMax = cms.double(3.5),
                                  TSpeakHEMin = cms.double(2.5),
                                  TSpeakHEMax = cms.double(3.5),
                                  ...
                                  ADCAmplHBMin = cms.double(150.),
                                  ADCAmplHBMax = cms.double(3000.),
                                  ADCAmplHEMin = cms.double(150.),
                                  ...
                                  #
                                   #
                                  HistOutFile = cms.untracked.string('run_211006.root'),
                                  #
                                  #
                                  #
                                  #
